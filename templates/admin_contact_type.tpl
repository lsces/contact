			...
			{section name=user loop=$contacttype}
				<tr class="{cycle values="even,odd"}">
					...
					<td align="right">
						...
						<br />
						<a href="{$smarty.const.CONTACT_PKG_URL}admin/admin_contact_type.php?fRemoveType=1&amp;topic_id={$contacttype[user].xref_type}">{biticon ipackage="icons" iname="user-trash" iforce=icon_text iexplain="Remove Contact Type"}</a>
					</td>
				</tr>
			{sectionelse}
				<tr class="norecords">
