				...
				{jstab title="Time period"}
					{legend legend="Start and Stop Dates"}
						<div class="row">
							...
							<input type="checkbox" name="ignore_start_date" {if $xrefInfo.ignore_start_date eq "y"}checked{/if} />
						...
						<div class="row">
							...
							<input type="checkbox" name="ignore_end_date" {if $xrefInfo.ignore_end_date eq "y"}checked{/if} />
